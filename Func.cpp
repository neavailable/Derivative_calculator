...
Func::Func() : head{ nullptr }, curr_func{ nullptr },
    entered_func{ true }, entered_pow{ false }, qstr_func{ "⬚" } {};
...
// we know, that only 2 type of funcs have ⬚ symbol at the end
...
// [in that method we add func to our tree] first if make a head, add first func
// second add last digit which entered user to number
// third if create a new func and add it to the tree. That func is arg of previous func
...
// in that method we delete elements like in a tree. So we go at the and of each branch
